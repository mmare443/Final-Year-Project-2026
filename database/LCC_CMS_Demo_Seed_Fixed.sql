/* =========================================================================
   LCC-CMS — demonstration seed (LCCCMSDB) — FIXED
   Date: 2026-09-13

   Same demo data as LCC_CMS_Demo_Seed.sql. Admissions inserts skip existing
   applicant_email and existing student_id (UNIQUE KEY that caused Msg 2627).
...
BEGIN TRANSACTION;
    ...
    /* Admissions (enrolment analytics): linked rows for the 18, plus extra reject/apply.
       UNIQUE KEY on dbo.admissions is student_id (UQ__admissio__… / student_id NULL UNIQUE).
       Guard both applicant_email AND student_id so a portal-approved application
       that used a different applicant_email but already linked student_id is skipped. */
    ...
    WHERE NOT EXISTS (SELECT 1 FROM dbo.admissions a WHERE a.applicant_email = s.email)
      AND NOT EXISTS (SELECT 1 FROM dbo.admissions a WHERE a.student_id = u.user_id);

    IF NOT EXISTS (SELECT 1 FROM dbo.admissions WHERE applicant_email = N'paul.kavieng.apply@gmail.com')
        INSERT INTO dbo.admissions (programme_id, applicant_name, applicant_email, applicant_phone, status, reviewed_by, decision_date, created_at)
        VALUES (@prog_bam_dip, N'Paul Kavieng', N'paul.kavieng.apply@gmail.com', N'675 72110001', N'Rejected', @registrar, CAST(N'2026-01-22' AS DATE), CAST(N'2025-11-18' AS DATETIME2));
    IF NOT EXISTS (SELECT 1 FROM dbo.admissions WHERE applicant_email = N'nancy.lae.apply@gmail.com')
        INSERT INTO dbo.admissions (programme_id, applicant_name, applicant_email, applicant_phone, status, reviewed_by, decision_date, created_at)
        VALUES (@prog_bam_dip, N'Nancy Lae', N'nancy.lae.apply@gmail.com', N'675 72110002', N'Rejected', @registrar, CAST(N'2026-01-22' AS DATE), CAST(N'2025-11-19' AS DATETIME2));
    IF NOT EXISTS (SELECT 1 FROM dbo.admissions WHERE applicant_email = N'mark.kerema.apply@gmail.com')
        INSERT INTO dbo.admissions (programme_id, applicant_name, applicant_email, applicant_phone, status, reviewed_by, decision_date, created_at)
        VALUES (@prog_min_dip, N'Mark Kerema', N'mark.kerema.apply@gmail.com', N'675 72110003', N'Rejected', @registrar, CAST(N'2026-01-23' AS DATE), CAST(N'2025-11-20' AS DATETIME2));
    IF NOT EXISTS (SELECT 1 FROM dbo.admissions WHERE applicant_email = N'rose.buka.apply@gmail.com')
        INSERT INTO dbo.admissions (programme_id, applicant_name, applicant_email, applicant_phone, status, reviewed_by, decision_date, created_at)
        VALUES (@prog_agr_dip, N'Rose Buka', N'rose.buka.apply@gmail.com', N'675 72110004', N'Rejected', @registrar, CAST(N'2026-01-23' AS DATE), CAST(N'2025-11-21' AS DATETIME2));
    IF NOT EXISTS (SELECT 1 FROM dbo.admissions WHERE applicant_email = N'eli.wabag.apply@gmail.com')
        INSERT INTO dbo.admissions (programme_id, applicant_name, applicant_email, applicant_phone, status, reviewed_by, decision_date, created_at)
        VALUES (@prog_bam_cert, N'Eli Wabag', N'eli.wabag.apply@gmail.com', N'675 72110005', N'Applied', @registrar, NULL, CAST(N'2026-02-02' AS DATETIME2));
    IF NOT EXISTS (SELECT 1 FROM dbo.admissions WHERE applicant_email = N'joy.aitape.apply@gmail.com')
        INSERT INTO dbo.admissions (programme_id, applicant_name, applicant_email, applicant_phone, status, reviewed_by, decision_date, created_at)
        VALUES (@prog_min_cert, N'Joy Aitape', N'joy.aitape.apply@gmail.com', N'675 72110006', N'Under Review', @registrar, NULL, CAST(N'2026-02-03' AS DATETIME2));
    IF NOT EXISTS (SELECT 1 FROM dbo.admissions WHERE applicant_email = N'silas.mendi.apply@gmail.com')
        INSERT INTO dbo.admissions (programme_id, applicant_name, applicant_email, applicant_phone, status, reviewed_by, decision_date, created_at)
        VALUES (@prog_agr_cert, N'Silas Mendi', N'silas.mendi.apply@gmail.com', N'675 72110007', N'Applied', @registrar, NULL, CAST(N'2026-02-04' AS DATETIME2));
